...
export class RaycastEngine {
  ...
  // Hover bypasses rButtons — it fires whenever the ray intersects the object.
  ...
  cast(
    ...
    if (intersects.length > 0) {
      ...
      for (const intersect of intersects) {
        // Walk up the ancestry to find the nearest registered hitbox.
        // Handles deep hierarchies (e.g. loaded 3MF models).
